...
<?php
                                if ($row['image'] != null){
?>
                                    <img src='<?=$lserver?>/img/blog/x8/$row[image]' height='224' width='224' />
<?php
                                }
?>
                                <?=$text?>
                        ...
                        <link><?=$lserver?>/blog/<?=$row["permalink"]?></link>
                        <guid><?=$lserver?>/blog/<?=$row["permalink"]?></guid>
<?php
                        break;
                    }
?>
